...
public class DeletePatienthealthInfoTrustStoreServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		try {
			...
			dao.removehealthInfoTrustStore(visit_id, email);
			...
			req.getRequestDispatcher("healthinfotruststore.jsp?msg=Deleted "+email+" from health information trust store").forward(req, resp);
